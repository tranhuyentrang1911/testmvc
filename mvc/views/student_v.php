    ...
    <div id="main">
        ...
        <div id="main__body">
            <div class="main__body-left float-left flex-col">
                ...
                <ul class="menu">
                    <li><a class="js-active" href="/testmvc/studentH">
                            <i class="fas fa-house-user"></i>
                            Home</a></li>
                    <li><a class="js-active" href="/testmvc/studentH/changepassword">
                            <i class="fas fa-key"></i>
                            Đổi mật khẩu</a></li>
                    <li><a class="js-active" href="/testmvc/studentH/information">
                            <i class="fas fa-info-circle"></i>
                            Thông tin cá nhân</a>

                    </li>
                    <li><a class="js-active"
                            href="/testmvc/studentH/studentDetail/<?php echo $data['student'][0]['id']; ?>">
                            <i class="fas fa-info-circle"></i>
                            Danh sách lớp theo học</a>
                    </li>
            ...
            <div class="main-body-right float-left">
                ...
                require_once "pages/student_layout/" . $data['page'] . ".php";
