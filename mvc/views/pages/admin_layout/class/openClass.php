    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="m-portlet">
                ...
                <!--begin::Form-->
                <form class="addClass m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                    action="" method="post">
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" name="tenlop" class="form-control m-input" placeholder="Toeic 500.1"
                                    required>
                                <span class="m-form__help">
                                    Nhập lại tên cũ nếu không muốn thay đổi.
                                </span>
                            </div>
                            <label class="col-lg-1 col-form-label">
                                Khóa:
                            ...
                            <div class="col-lg-3">
                                <input type="number" name="khoa" class="form-control m-input" placeholder="2000">
                                <span class="m-form__help">
                            ...
                            <div class="col-lg-3">
                                <input type="number" name="sobuoi" class="form-control m-input" placeholder="10">
                                <span class="m-form__help">
                                    Không thay đổi vui lòng để trống!
                                </span>
                            </div>
                    ...
                    <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                        <div class="m-form__actions m-form__actions--solid">
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <button type="submit" name="themlop" class="btn btn-brand">
                                        Thêm
                                    </button>
