<div class="m-content">                                         
    ...
    justify-content: flex-end;">
                                <div class="col-md-2">
                                    <a href="/testmvc/admin/addSale" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air " style="float: right; ">
                                        <span>
...
<!--begin: Datatable -->
            <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded" id="local_data" style="position: static; zoom: 1;">
                <table class="m-datatable__table" style="display: block; min-height: 300px; overflow-x: auto;">
                    <thead class="m-datatable__head"><tr class="m-datatable__row" style="left: 0px;">
                        ...
                        <th data-field="OrderID" class="m-datatable__cell m-datatable__cell--sort">
                            <span style="width: 110px;">Mã giảm giá</span> 
                        </th> 
                        <th data-field="OrderID" class="m-datatable__cell m-datatable__cell--sort">
                            <span style="width: 110px;">Giảm tiền mặt</span> 
                        </th> 
                        <th data-field="OrderID" class="m-datatable__cell m-datatable__cell--sort">
                            <span style="width: 110px;">Giảm theo %</span> 
                        </th> 
                        <th data-field="OrderID" class="m-datatable__cell m-datatable__cell--sort">
                            <span style="width: 110px;">Số lần hiệu lực</span> 
                        </th> 
                ...
                <tbody class="m-datatable__body" style="">
                    <?php $i=1; foreach ($data['list'] as $key => $value) { ?>     
                    <tr data-row="0" class="m-datatable__row" style="left: 0px;">
                        ...
                        <td data-field="OrderID" class="m-datatable__cell">
                            <span style="width: 110px;"><?php echo $value['magiamgia']; ?></span>
                        </td>
                        <td data-field="OrderID" class="m-datatable__cell">
                            <span style="width: 110px;"><?php echo number_format($value['sotien'])." VND"; ?></span>
                        </td>
                        <td data-field="OrderID" class="m-datatable__cell">
                            <span style="width: 110px;"><?php echo $value['sophantram']; ?> %</span>
                        </td>
                        <td data-field="OrderID" class="m-datatable__cell">
                            <span style="width: 110px;"><?php echo $value['solanhieuluc']; ?></span>
                        </td>
                        <td data-field="ShipDate" class="m-datatable__cell">
                            <span class="m-switch m-switch--outline m-switch--icon-check m-switch--brand" style="width: 110px;">
                                <label>
                                    <button class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air delSale" value="<?php echo $value['id']; ?>">Xóa</button> 
