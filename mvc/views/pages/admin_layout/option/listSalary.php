<div class="m-content">                                         
    ...
    justify-content: flex-end;">
                                <div class="col-md-2">
                                    <a href="/testmvc/admin/addSalary" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air " style="float: right; ">
                                        <span>
                ...
                <tbody class="m-datatable__body" style="">
                    ...
                    <tr data-row="0" class="m-datatable__row" style="left: 0px;">
                        ...
                        <td data-field="OrderID" class="m-datatable__cell">
                            <span style="width: 110px;"><?php echo number_format($value['luongcoban']*$value['hesoluong'])." VND"; ?></span>
                        </td>
                        <td data-field="ShipDate" class="m-datatable__cell">
                            <span class="m-switch m-switch--outline m-switch--icon-check m-switch--brand" style="width: 110px;">
                                <label>
                                    <button class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air delSalary" value="<?php echo $value['id']; ?>">Xóa</button> 
