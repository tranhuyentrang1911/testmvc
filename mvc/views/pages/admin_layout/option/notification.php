                ...
                <div class="row align-items-center">
                    <div class="col-xl-12 order-2 order-xl-1">
                        <div class="form-group m-form__group row align-items-center"
                            ...
                            <div class="col-md-2">
                                <a href="/testmvc/admin/addnotify"
                ...
                <thead class="m-datatable__head">
                    <tr class="m-datatable__row" style="left: 0px;">
                        ...
                        <th data-field="OrderID" class="m-datatable__cell m-datatable__cell--sort">
                            <span style="width: 200px;">Tên Khoá Học</span>
                        </th>
                        <th data-field="OrderID" class="m-datatable__cell m-datatable__cell--sort">
                            <span style="width: 250px;">Mô tả</span>
                        </th>
                        <th data-field="ShipName" class="m-datatable__cell m-datatable__cell--sort">
                            <span style="width: 200px; text-align: center;">Hình ảnh</span>
                        </th>
                ...
                <tbody class="m-datatable__body" style="">
                    ...
                    <tr data-row="0" class="m-datatable__row" style="left: 0px;">
                        ...
                        <td data-field="OrderID" class="m-datatable__cell">
                            <span
                                style="width: 200px; height: 100px; overflow-y: visible;"><?php echo $value['title']; ?></span>
                        </td>
                        <td data-field="OrderID" class="m-datatable__cell">
                            <span
                                style="width: 250px; height: 100px; overflow-y: visible;"><?php echo $value['content']; ?></span>
                        </td>
                        <td data-field="ShipName" class="m-datatable__cell">

                            <div style="width :200; text-align:center;">
                                <img src="/testmvc/public/img/tintuc/<?php echo $value['img']; ?>" alt="" width="100px"
                                    height="130px">
                        ...
                        <td data-field="ShipDate" class="m-datatable__cell">
                            <span class="m-switch m-switch--outline m-switch--icon-check m-switch--brand"
                                ...
                                <label>
                                    <input type="checkbox"
                                        <?php echo $value['active'] == 1 ? 'checked="checked"' : ''; ?>
                                        name="status-checkbox" value="<?php echo $value['id']; ?>">
                                    <input type="hidden" name='pageajax' value='notifi'>
                                    <span></span>
                                </label>
                            </span>
                        </td>
