            ...
            <div class="m-portlet__head-caption">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="/testmvc/admin/teacherEdit/<?php echo $data['teacherId']; ?>" class="m-nav__link">
                ...
                <thead class="m-datatable__head">
                    <tr class="m-datatable__row" style="left: 0px;">
                        ...
                        <th data-field="Currency" class="m-datatable__cell m-datatable__cell--sort">
                            <span style="width: 70px;">Số Buổi</span>
                        </th>
                ...
                <tbody class="m-datatable__body" style="">
                    ...
                    <tr data-row="0" class="m-datatable__row" style="left: 0px;">
                        ...
                        <td data-field="ShipAddress" class="m-datatable__cell">
                            <span style="width: 70px;"><?php echo $value['sobuoi']; ?></span>
                        </td>
                        ...
                        <td data-field="Status" class="m-datatable__cell">
                            <span style="width: 70px;">
                                <span
                                    class="m-badge <?php if ($value['hoatdong'] == '1') {
																echo "m-badge--success";
															} else echo "m-badge--danger" ?> m-badge--wide"><?php echo $val = $value['hoatdong'] == 1 ? 'Có' : 'Không'; ?></span>
                            </span>
                        </td>
                        ...
                        <td data-field="Actions" class="m-datatable__cell">
                            <span style="overflow: visible; position: relative; width: 110px;">
                                <a href="/testmvc/admin/editClass/<?php echo $value['id']; ?>">
