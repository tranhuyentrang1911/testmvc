                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" x-placement="top-end"
                                        ...
                                        <a class="dropdown-item"
                                            href="/testmvc/admin/studentEdit/<?php echo $value['id']; ?>"><i
                                                class="la la-refresh"></i> Sửa</a>
                                        <a class="dropdown-item"
                                            href="/testmvc/admin/studentDetail/<?php echo $value['id']; ?>"><i
                                                class="la la-eye"></i> Chi tiết</a>
                                        <a class="dropdown-item"
                                            href="/testmvc/admin/studentCourse/<?php echo $value['id']; ?>"><i
                                                class="la la-list"></i> Danh sách lớp</a>
                                        <a class="dropdown-item"
                                            href="/testmvc/admin/studentRegCourse/<?php echo $value['id']; ?>"><i
                                                class="la la-cart-plus"></i> Đăng ký lớp</a>
                                    </div>
